...
# Sweep operates locally and does not interact with GitHub Actions.
...
# Sweep operates locally and does not create pull requests.

# Sweep operates locally and does not have restrictions on directories.
```
...
### This section has been removed as Sweep no longer interacts with GitHub Actions.
...
### This section has been removed as Sweep no longer creates pull requests.
